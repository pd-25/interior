...
<section class="section-mb">
    <div class="container">
        ...
        <div class="section-pt">
            ...
            <p class="text-between-paragraph text-size-all-page text-center" class="alert alert-success alert-dismissible fade show mt-3" role="alert">
                {{ Session::get('success') }}

            </p>
            @endif
            @if(Session::has('error'))
            <p class="text-between-paragraph text-size-all-page text-center" class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                {{ Session::get('error') }}
            </p>
            @endif
        </div>
