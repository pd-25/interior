...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Home Banner Manager</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('adminDashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">
                        <a href="#" style="color: #6600ff;">Home Banner</a>
                    </li>
                </ol>
            </div>
        </div>
...
<div class="row">
    <div class="col-12 mb-3">
        <a href="{{route('homebanner.create')}}"  class="btn btn-warning">Add Banner</a>
    </div>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                    ...
                    <tbody>
                        @if (!@empty($homeBanner))
                            @foreach ($homeBanner as $index=>$item)
                                <tr>
                                    <td>{{@$index+1}}</td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group mt-2 me-1">
                                            ...
                                            <div class="dropdown-menu" style="">
                                                ...
                                                <a class="dropdown-item" href="{{ route('homebanner.destroy',$item->id) }}" onclick="return confirm('Are you sure want to delete this record?')"><i class="uil uil-trash-alt me-1"></i>Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
