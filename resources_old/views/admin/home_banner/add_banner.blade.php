        ...
        <div class="page-title-box">
            ...
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('homebanner.index') }}">Home Banner List</a></li>
...
<div class="row">
    <div class="col 12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{route('homebanner.store')}}" class="padding_infor_info" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
