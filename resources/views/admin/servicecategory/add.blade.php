    ...
    <div class="col-12">
        <div class="card">
            ...
            @endif --}}
                ...
                <form action="{{ route('Servicecategoryaddpost') }}" method="post"  name="addcategorie" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <label for="name" class="col-3 col-form-label">Service Category Name </label>
                        <div class="col-6">
                            <input type="text" name="name" class="form-control" id="name" placeholder="Service Name" value="" />
                            @error('name')
