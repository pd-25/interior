...
<div class="row">
    <div class="col 12">
        <div class="card">
            <div class="card-body">
                <form method="post" action="{{ route('service-cities.store') }}" class="padding_infor_info" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label for="name" class="form-label">City Name <span class="text-danger">*</span></label>
                            <input type="text" name="city_name" id="name" class="form-control" placeholder="Enter City Name" required>
                            @error('city_name')
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div id="sub-areas-container">
                                <div class="row mb-2 sub-area-row">
                                    <div class="col-md-4">
                                        <input type="text" name="sub_areas[0][sub_city_name]" class="form-control" placeholder="Enter Sub Area" required>
                                    </div>
                                    <div class="col-md-4">
                                        <select name="sub_areas[0][sub_city_status]" class="form-control">
                                            <option value="1">Active</option>
                                            <option value="0">Inactive</option>
                                        </select>
                                    </div>
