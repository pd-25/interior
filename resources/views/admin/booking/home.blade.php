...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">Home Booking Manager</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="{{ route('adminDashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">
                        <a href="#" style="color: #6600ff;">Home Booking's</a>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route("export_data")}}" method="post">
                    ...
                    @method('POST')
                    <div class="row mb-2">
                        <input type="hidden" name="category" value="home" id="">
                        <div class="col-4">
...
//         var excelDownloadType = $("#ExcelDownloadType").val();
//         var fromDate = $("#FromDate").val();
//         var toDate = $("#ToDate").val();
//         if(excelDownloadType != 0){
//             $.ajax({
...
//                     fromDate: fromDate,
//                     toDate: toDate,
//                     excelDownloadType : excelDownloadType,
//                     category: 'home'
//                 },
