<!-- Register Modal -->
<div class="modal fade login-modal-box" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="registerModalLabel"
    aria-hidden="true">
    <div class="modal-dialog register-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body login-body">
                <div class="mb-4">
                    <input type="text" placeholder="Enter Email/Mobile Number" name="register_email_mobile_no"
                        id="register_email_mobile_no" class="form-control">
                </div>
                <div class="login-btn">
                    <button class="login-submit" onclick="New_user_registration()">Request OTP</button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade login-modal-box" id="proceedModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog register-modal" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body login-body">
                <h5 class="modal-title otpmodeltitle"> </h5>
                <div class="mb-4">
                    <input type="text" name="otpnumber" id="otpnumber" placeholder="Enter OTP Number"
                        class="form-control">
                </div>
                <div class="login-btn">
                    <button class="login-submit" onclick="return User_otp_verification()">Verify
                        NUmber</button>
                </div>
                            ...
                            <a class="footer-logo-link" href="#">
                                ...
                                <div class="recident">
                                    <ul class="res-ul">
                                        ...
                                        <li class="res-li">
                                            Navigate your space design from start to finish
                                            effortlessly with our tech-centric platform. Seamlessly
                                            connect instantly with India's foremost designers,
                                            skilled contractors, and trusted vendors for a space
...
<script>
    function New_user_registration() {
        ...
        if (email_or_mobileno == '') {
            Swal.fire({
                icon: "error",
                title: "Oops...",
                text: "Please enter valid Email ID/Mobile number.",
                footer: ''
            });
        } else {
            // Send Otp email or mobile
            var form_data = new FormData();
            form_data.append('email_or_mobileno', email_or_mobileno);
            ...
            $.ajax({
                ...
                success: (response) => {
                    if (response == "Invalid entry") {
                        ...
                        var hiddenmobileno =
                            "<input type='hidden' id='mobileoremail' name='mobileoremail' value='" +
                            email_or_mobileno + "'>";

                        $(".otpmodeltitle").html(
                            "Please enter the OTP you've received on " +
                            email_or_mobileno + '' + hiddenmobileno);
