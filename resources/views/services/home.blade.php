...
<div class="interior-banner">
    <div class="interior-banner-slider owl-carousel owl-theme">
        <div class="item banner-item">
            <a href="javascript.void(0)"><img src="{{ asset('images/Residential01.png') }}" class="img_fluid"
...
<section class="section-mt">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="sec-title">
                    <h2>Residential Design Services</h2>
                </div>
                <p class="text-between-paragraph text-size-all-page">
                    At “I InterioFy”, we understand that your home is your sanctuary, a place where comfort meets style.
                    Our residential design services connect you with a network of talented designers who specialize in
                    creating beautiful, functional homes. Whether you're renovating a single room or redesigning your
                    entire home, our independent partners provide personalized solutions tailored to your style and
                    needs.
                </p>
                <p class="text-between-paragraph text-size-all-page">
                    Our platform makes the design process simpler and more efficient by bringing top-tier
                    designers directly to your doorstep. You can browse through a diverse portfolio of design
                    professionals, review their past projects, and select the one that best aligns with your vision.
                    From the initial consultation to the final implementation, our designers work closely with you to
                    understand your preferences, lifestyle, and budget, ensuring that every detail is meticulously
                    planned and executed.
                </p>
                <p class="text-between-paragraph text-size-all-page">
                    Whether you’re dreaming of a modern minimalist kitchen, a cozy and inviting
                    living room, or a luxurious master bedroom, our platform provides the expertise and creativity
                    needed to bring your dream home to life.
                </p>
