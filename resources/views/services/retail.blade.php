...
<!-- Retail Interior Banner -->
<div class="interior-banner">
    <div class="interior-banner-slider owl-carousel owl-theme">
        <div class="item banner-item">
            <a href="javascript.void(0)"><img src="{{ asset('images/retail01.png') }}" class="img_fluid"
                    style="object-fit: cover; height: -webkit-fill-available;" alt="No Images"></a>
        </div>
    </div>
</div>
<!-- End Retail Interior Banner -->
<!-- content area starts -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <p class="text-between-paragraph text-size-all-page">
                    Creating an engaging and attractive shopping environment is crucial for attracting customers and
                    driving sales. Our retail design services connect you with expert designers who specialize in
                    crafting visually stunning and functional retail spaces. Whether you are launching a new store,
                    renovating an existing one, or expanding your retail chain, our independent partners offer
                    innovative design solutions that captivate customers and enhance their shopping experience. From
                    layout planning to visual merchandising, our partners ensure your retail space reflects your brand
                    and drives sales.
                </p>
                <p class="text-between-paragraph text-size-all-page">
                    Our platform makes the process of finding and collaborating with top-tier retail
                    designers simple and efficient. You can browse through portfolios, review client reviews, and select
                    the designer who best understands your brand and vision. From initial concept development to final
                    implementation, our designers work closely with you to create a retail space that reflects your
                    brand identity and meets your business objectives.
                </p>
                <p class="text-between-paragraph text-size-all-page">
                    Whether you’re aiming for a chic boutique, a
                    high-end department store, or a trendy pop-up shop, our platform provides the creativity and
                    expertise needed to bring your retail vision to life.
                </p>
