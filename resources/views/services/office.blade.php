...
<div class="interior-banner">
    <div class="interior-banner-slider owl-carousel owl-theme">
        <div class="item banner-item">
            <a href="javascript.void(0)"><img src="{{ asset('img/officeCommerc.png') }}" class="img_fluid" style="object-fit: cover; height: -webkit-fill-available;" alt="No Images"></a>
        </div>
    </div>
</div>
...
<section class="section-mt">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="sec-title">
                    <h2>Office/Commercial Design Services</h2>
                </div>
                <p class="text-between-paragraph text-size-all-page">
                    Creating an inspiring and productive workspace is essential for the success of any business. At “I InterioFy”, our office/commercial design services bring together experienced designers and architects to
                    transform your workspace into a productive and inspiring environment. Our independent partners
                    specialize in designing offices, co-working spaces, and other office/commercial properties, ensuring they
                    are both functional and aesthetically pleasing. By understanding your business needs and brand
                    identity, our partners help create spaces that enhance employee well-being and impress clients.
                    Whether you are designing a new office, renovating a co-working space, or planning a corporate
                    headquarters, our independent partners offer tailored solutions that reflect your business needs and
                    brand identity.
                </p>
                <p class="text-between-paragraph text-size-all-page">
                    Our platform simplifies the design process by providing easy access to a curated
                    network of top-tier design professionals. You can review their portfolios, read client testimonials,
                    and select the designer who best understands your vision and requirements. From space planning and
                    interior design to project management and execution, our designers ensure that every aspect of your
                    office/commercial project is handled with precision and professionalism.
                </p>
...
<section>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="circle_div_1 step_icon_row row_1">
                    <a href="{{ url('/services/design') }}" class="step_icon_box_1 color_3 circle_3">
                        <div class="step_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0" y="0"
                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"
            ...
            <div class="col-md-4">
                <div class="circle_div_1 step_icon_row row_1">
                    <a href="{{ url('/services/contractor') }}" class="step_icon_box_1 color_5 circle_5">
                        ...
                        <h3 class="step_name">Contractor</h3>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="circle_div_1 step_icon_row row_1">
                    <a href="{{ url('/services/painting') }}" class="step_icon_box_1 color_7 circle_1">
                        <div class="step_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0" y="0"
                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"
                        ...
                        <h3 class="step_name">Painting</h3>
                    </a>
                </div>
            </div>
            <div class=" col-md-4">
                <div class="circle_div_1 step_icon_row row_1">
                    <a href="{{ url('/services/plumbing') }}" class="step_icon_box_1 color_8 circle_2">
                        <div class="step_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0"
                                viewBox="0 0 16.933 16.933" style="enable-background:new 0 0 512 512"
                        ...
                        <h3 class="step_name">Plumbing</h3>
                    </a>
                </div>
            </div>
            <div class=" col-md-4">
                <div class="circle_div_1 step_icon_row row_1">
                    <a href="{{ url('/services/furniture-fixtures    ') }}" class="step_icon_box_1 color_9 circle_3">
                        <div class="step_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0" y="0"
                                viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve"
                        ...
                        <h3 class="step_name">Furniture & Fixtures</h3>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="service_slider owl-carousel owl_navigation">
                ...
                <a href="#">
                    <div class="holiday_pack_area">
                        <div class="service-pack-pic">
                            <img class="img-fluid" src="images/Minimalism-01.png" alt="" />
                        </div>
                    </div>
                </a>
            </div>
            <div class="service_box">
                <a href="#">
                    <div class="holiday_pack_area">
                        <div class="service-pack-pic">
                            <img class="img-fluid" src="images/Minimalism-02.jpg" alt="" />
                        </div>
                    </div>
                </a>
            </div>
            <div class="service_box">
                <a href="#">
                    <div class="holiday_pack_area">
                        <div class="service-pack-pic">
                            <img class="img-fluid" src="images/Minimalism-03.webp" alt="" />
                        </div>
                    </div>
                </a>
            </div>
            <div class="service_box">
                <a href="#">
                    <div class="holiday_pack_area">
                        <div class="service-pack-pic">
                            <img class="img-fluid" src="images/Minimalism-04.webp" alt="" />
                        </div>
                    </div>
                </a>
            </div>
            <div class="service_box">
                <a href="#">
                    <div class="holiday_pack_area">
                        <div class="service-pack-pic">
                            <img class="img-fluid" src="images/Minimalism-05.jpg" alt="" />
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="row pb-4 d-flex justify-content-center ">
            ...
            <div class="col-12 text-center  col-md-2 d-flex align-items-center justify-content-center">
                <div class="image-title">
                    ...
                    <h4>Share <br> your requirement</h4>
                </div>
            </div>
            ...
            <div class="col-12 text-center col-md-2 d-flex align-items-center justify-content-center">
                <div class="image-title">
                    ...
                    <h4>Partner to <br> quote for execution </h4>
                </div>
            </div>
            <div class="col-12 col-md-1  d-flex align-items-center justify-content-center">
                <div class="image-title">
